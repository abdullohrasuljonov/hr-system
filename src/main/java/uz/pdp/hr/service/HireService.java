...
import uz.pdp.hr.entity.Company;
...
import uz.pdp.hr.repository.CompanyRepository;
import uz.pdp.hr.repository.EmployeeRepository;
import uz.pdp.hr.repository.RoleRepository;
...
public class HireService {
    ...
    public ApiResponse addManager(EmployeeHireDto dto) {
        if (employeeRepository.existsByEmail(dto.getEmail()))
            return new ApiResponse("Employee has already exist!", false);

        Employee employee = createEmployee(dto);
        employee.setRoles(Collections.singleton(roleRepository.findByRoleEnum(RoleName.ROLE_HR_MANAGER)));
    ...
    public ApiResponse addDirector(EmployeeHireDto dto) {
        ...
        Employee employee = createEmployee(dto);
        employee.setRoles(Collections.singleton(roleRepository.findByRoleEnum(RoleName.ROLE_DIRECTOR)));
    ...
    public ApiResponse addWorker(EmployeeHireDto dto) {
        ...
        Employee employee = createEmployee(dto);
        employee.setRoles(Collections.singleton(roleRepository.findByRoleEnum(RoleName.ROLE_WORKER)));
